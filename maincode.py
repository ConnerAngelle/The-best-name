...
class Trash(Frame):
    ...
    def stayOpen(self, openButton, text):
        ...
        closeButton = Button(window, text = "Close",\
                             width = 100, height = 100, command = lambda: self.close(closeButton, text))
    ...
    def close(self, closeButton, text):
        ...
        openButton = Button(window, text = "Open",\
                            width = 100, height = 100, command = lambda: self.stayOpen(openButton, text))
    ...
    def setupGUI(self, c):
        ...
        exitButton = Button(window, text = "Exit",\
                            width = 100, height = 100, command = lambda: self.Quit())
