...
class Trash(Frame):
    ...
    def stayOpen(self, openButton, text):
        ...
        closeButton = Button(window, text = "Close",\
                             width = 10, height = 10, command = lambda: self.close(closeButton, text))
    ...
    def close(self, closeButton, text):
        ...
        openButton = Button(window, text = "Open",\
                            width = 10, height = 10, command = lambda: self.stayOpen(openButton, text))
    ...
    def setupGUI(self, c):
        ...
        exitButton = Button(window, text = "Exit",\
                            width = 10, height = 10, command = lambda: self.Quit())
